...
<head>
	<meta charset="utf-8">
	<title>JKS Store | Online Shopping</title>
	...
	<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">JKS Store</a>
			</div>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>Hello, Guest</a>
				<ul class="dropdown-menu">
					<li><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart-large"></span>Cart Checkout</a></li>
...
<p> Made By <a href="#" data-toggle="tooltip" title="Hey there, Happy Shopping!">JKS</a></p>
</footer></div>
