<?php 
	...
	if(empty($f_name) || empty($l_name) || empty($email) || empty($password) || empty($mobile) || empty($gender) ){
		...
		exit();
					...
					$sql="INSERT INTO user_info (first_name, last_name, email, password, mobile, gender) VALUES ('$f_name','$l_name','$email','$password','$mobile','$gender')";
